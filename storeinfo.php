...
<head>
    ...
    <title>Khang Thi Information</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseInfo" aria-expanded="true"
                ...
                <div id="collapseInfo" class="collapse show" aria-labelledby="headingInfo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="storeinfo.php">Thông tin</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Thông tin cửa hàng</h1>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <form class="card-body text-center">
                                    <div class="card-body_item">
                                        <label for="" >Tên cửa hàng<sup>*</sup></label>
                                    ...
                                    <div class="card-body_item">
                                        <label for="" >Mã số thuế<sup>*</sup></label>
                                        <input class="card-body_input" type="text" required>
                                    </div>
                                    <div class="card-body_item">
                                        <label for="" >Đại diện<sup>*</sup></label>
                                        <input class="card-body_input" type="text" required>
                                    </div>
                                    <div class="card-body_item">
                                        <label for="" >Điện thoại<sup>*</sup></label>
                                        <input class="card-body_input" type="text" required>
                                    </div>
                                    <div class="card-body_item">
                                    ...
                                    <div class="card-body-btn">
                                        <button href="#" class="btn btn-primary">Lưu thông tin
                                        </button>
                                    </div>
