...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Support -->
            <li class="nav-item active"  style="margin-left: 3px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <p>Mọi thắc mắc vui lòng liên hệ với chúng tôi qua số điện thoại (+84)935091775.
                                    </p>
